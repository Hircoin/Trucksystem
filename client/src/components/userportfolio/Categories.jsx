    ...
    return (
        <StyledTable>
            <TableHead>
                <TableRow>
                    <TableCell>
                        <StyledLink to={""} onClick={() => setSelectedCountry("")}>All Positions {market}  {idname}</StyledLink>
                    </TableCell>
                </TableRow>
                <TableRow>
                    <TableCell>
                        {selectedCountry !== "Active" && (
                            <StyledheaderButton variant="contained" onClick={() => { setSelectedCountry("Active"); navigate("?market=Active"); }}>Active</StyledheaderButton>
                        )}
                        {selectedCountry !== "Complete" && (
                            <StyledheaderButton variant="contained" onClick={() => { setSelectedCountry("Complete"); navigate("?market=Complete"); }}>Complete</StyledheaderButton>
                        )}
                    </TableCell>
                </TableRow>
            </TableHead>

...
const getRandomDirection = () => {
    ...
    // Sample data
    const rows = [
        { id: 1, company: 'View This Month Paybills', revenue:`/Paybills/Month?renter=${id}` },
        { id: 2, company: 'View Last Month Paybills', revenue: `/Paybills/LastMonth?renter=${id}` },
        { id: 3, company: 'View This Year Paybills', revenue:`/Paybills/Year?renter=${id}`},
        { id: 4, company: 'View Last Year Paybills', revenue: `/Paybills/LastYear?renter=${id}` },
        { id: 5, company: 'View Select Period For Paybills', revenue: `/Paybills/Period?renter=${id}` },
        { id: 6, company: 'Add Paybill', revenue: `/add/Paybills/rentbill?renter=${id}` },

...
const getRandomDirection = () => {
    ...
    // Sample data
    const rows = [
        { id: 1, company: 'View This Month Report', revenue:`/Report/Month?renter=${id}` },
        { id: 2, company: 'View Last Month Report', revenue: `/Report/LastMonth?renter=${id}` },
        { id: 3, company: 'View This Year Report', revenue:`/Report/Year?renter=${id}`},
        { id: 4, company: 'View Last Year Report', revenue: `/Report/LastYear?renter=${id}` },
        { id: 5, company: 'View Select Period For Report', revenue: `/Report/Period?renter=${id}` },
        { id: 6, company: 'Add Rentbill', revenue: `/add/Rentbill?renter=${id}` },
        { id: 7, company: 'Add Paybill', revenue: `/add/Paybills/rentbill?renter=${id}` },

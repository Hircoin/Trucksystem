...
const getRandomDirection = () => {
    ...
    const rows = Object.values(flore).map(item => ({
        company: `${item.flourName}`,
        revenue: `/add/Paybills/renter?flore=${item._id}&property=${item.propertyId}`
    }));
    // Define columns ?flore=6731ae21a45e9999805d16b0&market=67302f1a4991bfaa560136b2
    const columns = [
...
export default Addrentbillflore ;

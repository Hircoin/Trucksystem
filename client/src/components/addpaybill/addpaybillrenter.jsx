...
const getRandomDirection = () => {
    ...
    const rows = Object.values(renter).map(item => ({
        company: `${item.renterName} & (${item.renterRoomNum})`,
        // revenue: `/add/Paybills?renter=${item._id}`
        revenue: `/add/Paybills/rentbill?renter=${item._id}`
    }));
    // Define columns
    const columns = [
...
export default Addrentbillrenter ;
